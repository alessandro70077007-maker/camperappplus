...
datas = [('app.py', '.'), ('storage.py', '.'), ('pdf_export.py', '.'), ('translations.py', '.'), ('backup.py', '.'), ('notifications.py', '.'), ('poi.py', '.'), ('desktop_notif.py', '.'), ('weather.py', '.'), ('affiliates.py', '.'), ('icon.png', '.'), ('icon.ico', '.'), ('LEGGIMI.txt', '.'), ('README.txt', '.')]
binaries = []
